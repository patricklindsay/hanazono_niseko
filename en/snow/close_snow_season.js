...
$(function(){
	...
	// 終了告知用の背景等を設置する。
	$('body').prepend('<img src="img/btn_close.png" alt="Close" id="btn_close" class="none" /><div id="close_snow_season" class="tc none">&ensp;</div><div id="close_snow_season_bg" class="tc none">&ensp;</div>');
