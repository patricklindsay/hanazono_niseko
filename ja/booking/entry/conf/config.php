...
// 送信メール件名
define('TO_SUBJECT', '[HANAZONO FREESTYLE COMP エントリー]');
...
define('AUTO_REPLY_SUBJECT', '[HANAZONO FREESTYLE COMP エントリー]【自動返信】');
...
define('AUTO_REPLY_NAME', '日本ハーモニー・リゾート株式会社 イベントエントリー受付係');
