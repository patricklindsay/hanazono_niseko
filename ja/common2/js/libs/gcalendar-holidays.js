...
var GCalHolidays = {
    ...
    userIds: [
        "ja.japanese#holiday@group.v.calendar.google.com"  //Google公式版
    ...
    datepickerStyles: {
        sunday:   "background-image: none; background-color: #f6bfbc", //日曜日
        saturday: "background-image: none; background-color: #bbc8e6", //土曜日
        holiday:  "background-image: none; background-color: #f6bfbc"  //祝日
    }
};
/**
 *  祝日を取得する
...
GCalHolidays._entries2days = function(entries) {
    ...
    for (var i = 0, len = entries.length; i < len; i++) {
        ...
        //年月日は使いやすいように数値にする
        if (title == 'クリスマス' || title == '大晦日' || title == '銀行休業日') continue;
        //days[i] = { year: ymd[0] * 1, month: ymd[1] * 1, date: ymd[2] * 1, title: title };
        days.push({ year: ymd[0] * 1, month: ymd[1] * 1, date: ymd[2] * 1, title: title });
    }
